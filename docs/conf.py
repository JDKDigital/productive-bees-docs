...
htmlhelp_basename = 'ProductiveBeesDocumentationdoc'
...
man_pages = [
    (master_doc, 'productivebeesdocumentation', u'Productive Bees Documentation Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ProductiveBeesDocumentation', u'Productive Bees Documentation Documentation',
     author, 'ProductiveBeesDocumentation', 'One line description of project.',
     'Miscellaneous'),
]
